...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($conexao, "INSERT INTO madeiras(nome,quantidade,valor)
...
<head>
    ...
    <title>Cadastro - Madeiras | 🏗️</title>
</head>
...
<body>
    ...
    <main>
        ...
        <!-- loading -->
        <div class="box">
            <form action="cad-madeiras.php" method="post">

                <h2>Madeiras</h2><br><br>
