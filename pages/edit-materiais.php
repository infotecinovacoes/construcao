...
if (!empty($_GET['id'])) {
    $id = $_GET['id'];
    $sqlSelect = "SELECT * FROM materiais WHERE id=$id";
...
<head>
    ...
    <title>Editar Materiais | 🏗️</title>
</head>
...
<body>
    ...
    <main>
        ...
        <!-- loading -->
        <div class="box">
            <form action="saveEditMateriais.php" method="post">

                <h2>Cadastrar Materiais Elétricos</h2><br><br>
