...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($conexao, "INSERT INTO pisos(nome,quantidade,valor)
...
<head>
    ...
    <link rel="stylesheet" href="../style/cad-pisos.css">
    <title>Cadastro - Pisos e Revestimentos | 🏗️</title>
</head>
...
<body>
    ...
    <main>
        ...
        <!-- loading -->
        <div class="box">
            <form action="cad-pisos.php" method="post">

                <h2>Pisos e Revestimentos</h2><br><br>
